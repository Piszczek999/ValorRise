...
internal class LoginAuthRequest : IMessageHandler
{
    ...
    public void HandleMessage(ushort gatewayId, Message message)
    {
        ...
        var args = new LoginAuthRequestEvent(gatewayId, clientId, username, password);
...
public class LoginAuthRequestEvent : EventArgs
{
    ...
    public LoginAuthRequestEvent(ushort gatewayId, ushort clientId, string username, string password)
    {
        GatewayId = gatewayId;
        ClientId = clientId;
        Username = username;
